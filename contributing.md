...
kindly [ask](https://github.com/snd/mel/issues/new) before implementing new features.**
...
**communicate !**  
[write an issue](https://github.com/snd/mel/issues/new) to start a discussion before writing code that may or may not get merged.
